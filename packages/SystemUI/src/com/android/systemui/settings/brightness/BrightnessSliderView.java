    ...
    private void applySliderScale() {
        if (mProgressDrawable != null) {
            ...
            if (mProgressBgDrawable != null) {
                final Drawable sliderBackground = mSlider.getCurrentDrawable();
                final Rect rBgBounds = sliderBackground.getBounds();
                mProgressBgDrawable.setBounds(rBgBounds.left, inset, rBgBounds.right,
                        inset + height);
            }
